...
const partners = [
  ...
  { src: '/logos/image8.jpeg', alt: 'Alkasbi' },
  { src: '/logos/image9.jpeg', alt: 'Partenaire 9' },
  { src: '/logos/image10.jpeg', alt: 'Ecores' },
]
    ...
    <section className="py-24 overflow-hidden bg-secondary/30 relative">
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="text-center">
          ...
          <div className="w-20 h-1 bg-accent mx-auto mb-6 font-semibold"></div>
      ...
      <div className="relative flex items-center">
        ...
        <div className="flex whitespace-nowrap animate-scroll-reverse hover:[animation-play-state:paused] py-4">
          {allPartners.map((partner, index) => {
            const isEcores = partner.alt === 'Ecores'
            return (
              <div
                key={index}
                className="mx-6 flex flex-col items-center justify-center min-w-[200px] h-[100px] rounded-xl bg-white border-2 border-white shadow-sm transition-all duration-300 hover:shadow-md hover:border-accent/40 group"
              >
                <div className="relative w-full h-full flex items-center justify-center p-4">
                  <Image
                    ...
                    width={150}
                    height={75}
                    className={`object-contain max-h-full max-w-full opacity-80 group-hover:opacity-100 transition-all duration-300 mix-blend-multiply dark:mix-blend-normal ${
                      isEcores ? 'scale-150 md:scale-[1.65]' : ''
                    }`}
                  />
                </div>
              </div>
